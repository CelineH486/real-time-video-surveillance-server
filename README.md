...
Run the files in `db/migrations/` in numeric order when installing against an existing PostgreSQL server. The Docker Compose development stack applies them automatically to a new database volume.
